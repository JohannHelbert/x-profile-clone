            ...
            <v-col cols='12' class='d-flex justify-space-between'>
                ...
                <v-avatar size='50' image='/vuemastery_logo.png'></v-avatar>
                    <p class='ml-2 mt-2'>
                        ...
                        <v-row>
                            <v-col cols='4'><v-icon icon='mdi-chat-outline'></v-icon></v-col>
                            <v-col cols='4'><v-icon icon='mdi-repeat-variant'></v-icon></v-col>
                            <v-col cols='4'><v-icon icon='mdi-heart-outline'></v-icon></v-col>
                        </v-row>
                    </p>
                    </div>
